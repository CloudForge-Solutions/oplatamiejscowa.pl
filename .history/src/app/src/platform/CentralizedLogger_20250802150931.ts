...
export class CentralizedLogger implements LoggerInterface {
    ...
    /**
     * Generic log method with automatic level detection
     */
    log(message: string, data?: any, context?: string): LogEntry {
    ...
    private createLogEntry(level: string, message: string, data?: any, context?: string): LogEntry {
        ...
        // Persist logs to localStorage (simple storage architecture)
        this.persistLogs();

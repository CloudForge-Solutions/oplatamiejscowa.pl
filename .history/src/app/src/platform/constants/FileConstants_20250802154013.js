/**
 * File Constants - Single Source of Truth for File Operations
 *
 ...
 * 3. Maintainability: Easy to update file patterns and types
 * 4. Consistency: Standardized file handling patterns
 *
 * CATEGORIES:
 * - FILE_EXTENSIONS: File extension patterns
 * - MIME_TYPES: MIME type constants
 * - FILE_PATTERNS: File name pattern matching
 * - FILE_SIZES: File size limits and constants
 * - ENCODING: File encoding constants
 */

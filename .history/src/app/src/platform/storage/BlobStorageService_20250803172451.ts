...
// Note: Using browser-compatible mock instead of @azure/storage-blob for client-side compatibility
...
/**
 * BlobStorageService - Azure Storage Emulator integration
 */
export class BlobStorageService {
  ...
  constructor(config: BlobStorageConfig) {
    ...
    try {
      // Initialize Azure Storage Emulator client
      this.blobServiceClient = BlobServiceClient.fromConnectionString(config.connectionString);
      this.containerClient = this.blobServiceClient.getContainerClient(config.containerName);

      logger.info('🗄️ BlobStorageService initialized', {

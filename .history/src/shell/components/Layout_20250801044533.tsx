...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="d-flex flex-column vh-100">
      {/* Top Horizontal Navbar - Adapted from mVAT */}
      <Navbar bg="white" expand="lg" className="border-bottom shadow-sm" style={{ minHeight: '60px' }}>
        <Container fluid className="px-3">
          ...
          >
            <div className="app-logo me-2" style={{

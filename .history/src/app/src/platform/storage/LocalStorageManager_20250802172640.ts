...
export class LocalStorageManager {
    ...
    getPreferences(): TouristTaxPreferences {
        const preferences = this.this.storageService.get<TouristTaxPreferences>(
    ...
    getFormCache(): TouristTaxFormCache | null {
        return this.storageService.get<TouristTaxFormCache>(
    ...
    clearFormCache(): boolean {
        const success = this.storageService.remove(STORAGE_KEYS.TOURIST_TAX_FORM_CACHE);
    ...
    getSession(): TouristTaxSession | null {
        return this.storageService.get<TouristTaxSession>(
    ...
    clearSession(): boolean {
        const success = this.storageService.remove(STORAGE_KEYS.TOURIST_TAX_SESSION);
    ...
    getGDPRConsents(): GDPRConsents | null {
        return this.storageService.get<GDPRConsents>(
    ...
    getAppVersion(): string | null {
        return this.storageService.get<string>(STORAGE_KEYS.TOURIST_TAX_APP_VERSION);
    }
    ...
    setAppVersion(version: string): boolean {
        return this.storageService.set(STORAGE_KEYS.TOURIST_TAX_APP_VERSION, version);
    }
    ...
    clearAllData(): boolean {
        ...
        let success = true;
        keys.forEach(key => {
            if (!this.storageService.remove(key, { silent: true })) {
                success = false;
            }
        });

...
export class EventBus implements EventBusInstance {
    ...
    constructor() {
        ...
        logger.info('📡 EventBus initialized with validation');
    }
    ...
    registerSchema(eventName: string, schema: any): void {
        ...
        if (this.debugMode) {
            logger.info(`Event schema registered: ${eventName}`);
        }
    }
    ...
    destroy(): void {
        ...
        this.eventHistory = [];
        logger.info(`📡 EventBus destroyed (cleaned up ${totalSubscriptions} subscriptions)`);
    }
    ...
    private initializeDefaultSchemas(): void {
        ...
        logger.info('Default event validation schemas initialized with constants');
    }
}

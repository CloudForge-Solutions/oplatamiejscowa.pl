        ...
        <Col lg={8} xl={6}>
          ...
          <div className="text-center mb-4">
            ...
            <p className="text-muted">
              Complete your tourist tax payment for {reservation.cityName}
            </p>
          </div>
          ...
          <div className="card mb-4">
            ...
            <div className="card-body">
              <div className="row">
                <div className="col-md-6">
                  <div className="mb-3">
                    ...
                    <div className="fw-bold">{reservation.cityName}</div>
                  </div>
                  <div className="mb-3">
                ...
                <div className="col-md-6">
                  ...
                  <div className="mb-3">
                    ...
                    <div className="fw-bold">{reservation.guests} guests</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-light p-3 rounded mt-3">
                ...
                <small className="text-muted">
                  {reservation.guests} guests × {reservation.numberOfNights} nights
                </small>
              </div>
            </div>
          </div>
                  ...
                  >
                    {isLoadingPayment ? (
                      ...
                      <>
                        ...
                        Pay {formatCurrency(reservation.totalAmount)}
                      </>
                    )}
                  </button>
                  <div className="mt-3">

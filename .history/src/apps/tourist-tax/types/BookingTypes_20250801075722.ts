...
// Standard Booking.com export columns (based on sample file)
export const BOOKING_COLUMNS: BookingExportColumn[] = [
  { index: 0, name: 'Numer rezerwacji', mapping: 'reservationNumber' },
  { index: 1, name: 'Zarezerwowa B(a)', mapping: null },
  { index: 2, name: 'Imię i nazwisko gościa(a)', mapping: 'guestName' },
  ...
  { index: 22, name: 'Rodzaj opcji zakwaterowania', mapping: null },
  { index: 23, name: 'Czas trwania (noce)', mapping: 'numberOfNights' },
  { index: 24, name: 'Data odwołania', mapping: null },
  { index: 25, name: 'Adres', mapping: 'accommodationAddress' },

...
const logger = createComponentLogger('ImportPreviewModal');
...
const ImportPreviewModal: React.FC<ImportPreviewModalProps> = ({
  ...
  const loadAvailableCities = async () => {
    try {
      ...
      setError('Failed to load available cities. Please try again.');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <Modal show={show} onHide={onHide} size="xl" backdrop="static" className="import-preview-modal">
          ...
          <div className="import-table-container">
            <Table striped bordered hover size="sm">
              <thead className="sticky-top bg-light">
                <tr>
                  <th className="import-table-checkbox-col"></th>

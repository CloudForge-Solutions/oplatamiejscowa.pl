...
// src/js/utils/ValidationErrorReporter.js
// Detailed validation error reporting and formatting
...
export class ValidationErrorReporter {
  ...
  /**
   * Generate detailed error report for validation results
   * @param {Object} validationResult - Result from DeepSeek validators (BasicDataValidator, DetailedDataValidator, PositionsDataValidator)
   * @param {string} fileName - Name of the processed file
   * @returns {Object} Formatted error report
   */
  generateReport(validationResult, fileName) {
    ...
    return {
      ...
      details: this.formatErrorDetails(errors, warnings),
      htmlReport: this.generateHTMLReport(validationResult, fileName),
      textReport: this.generateTextReport(validationResult, fileName),
      actionable: this.generateActionableItems(errors, warnings),
    };
  }

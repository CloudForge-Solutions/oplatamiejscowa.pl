...
IMPORTANT: all modals should be resizable and reusing src/platform/components/commonIndexedDB databases should be isolated per entity dbs and global dbs for some cases

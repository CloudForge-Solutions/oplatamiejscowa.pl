...
**Key Applications** (`src/app/apps/` - simplified for payment focus):
- **Payment App** (`src/app/apps/payment/`) - Tourist payment flow (mobile-first)

**Platform Services** (`src/app/platform/` - essential services only):
- **Storage Layer** - Blob storage service with SAS token management
- **API Layer** - Payment status polling and imoje integration
- **Validation Layer** - Form validation and data validation services

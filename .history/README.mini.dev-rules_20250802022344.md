...
NOTE: we have the records page to work on, ui/ux part looks ready, but an new record modal, new fixed assets modal, an upload queue modal and related analysis, processing, and deepseek may have issues after recent migrations to react and directory structure refactoring
